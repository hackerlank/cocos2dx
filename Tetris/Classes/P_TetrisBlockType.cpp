...
void P_TetrisBlockType::init()
{
	...
	if(t_typeIndex == 1)
	{
		...
		_bk->b_Update_C_R(_colum + 1, _row + 1/* - 1*/);
	}
	if(t_typeIndex == 2)
	{
		TetrisBlock * _bk = (TetrisBlock*)t_childBlockArray->objectAtIndex(0);
...
bool P_TetrisBlockType::T_checkDropDown()
{
...
void P_TetrisBlockType::T_dropDown()
{
...
bool P_TetrisBlockType::T_checkLeftMove()
{
	if (t_typeIndex == 0)
	{
		TetrisBlock *_block1 = (TetrisBlock*)t_childBlockArray->objectAtIndex(1);
...
void P_TetrisBlockType::T_leftMove()
{
	for (unsigned int i = 0; i < t_count; ++i)
	{
		TetrisBlock * _block = (TetrisBlock*)t_childBlockArray->objectAtIndex(i);
...
bool P_TetrisBlockType::T_checkRightMove()
{
	if (t_typeIndex == 0)
	{
		TetrisBlock *_block2 = (TetrisBlock*)t_childBlockArray->objectAtIndex(2);
...
void P_TetrisBlockType::T_rightMove()
{
	for (unsigned int i = 0; i < t_count; ++i)
	{
		TetrisBlock *_block = (TetrisBlock*)t_childBlockArray->objectAtIndex(i);
...
void P_TetrisBlockType::T_rotate()
{
...
void P_TetrisBlockType::T_updateTetrisStateArray(int _value)
{
	for (unsigned int i = 0; i < t_count; ++i)
	{
		TetrisBlock *_block = (TetrisBlock*)t_childBlockArray->objectAtIndex(i);
