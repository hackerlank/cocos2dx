...
bool S_TetrisBlockType::T_checkDropDown()
{
...
void S_TetrisBlockType::T_dropDown()
{
...
bool S_TetrisBlockType::T_checkLeftMove()
{
	if (t_typeIndex == 1)
	{
		TetrisBlock *_block1 = (TetrisBlock*)t_childBlockArray->objectAtIndex(1);
...
void S_TetrisBlockType::T_leftMove()
{
	for (unsigned int i = 0; i < t_count; ++i)
	{
		TetrisBlock * _block = (TetrisBlock*)t_childBlockArray->objectAtIndex(i);
...
bool S_TetrisBlockType::T_checkRightMove()
{
	if (t_typeIndex == 1)
	{
		TetrisBlock *_block0 = (TetrisBlock*)t_childBlockArray->objectAtIndex(0);
...
void S_TetrisBlockType::T_rightMove()
{
	for (unsigned int i = 0; i < t_count; ++i)
	{
		TetrisBlock *_block = (TetrisBlock*)t_childBlockArray->objectAtIndex(i);
...
void S_TetrisBlockType::T_rotate()
{
...
void S_TetrisBlockType::T_updateTetrisStateArray(int _value)
{
	for (unsigned int i = 0; i < t_count; ++i)
	{
		TetrisBlock *_block = (TetrisBlock*)t_childBlockArray->objectAtIndex(i);
